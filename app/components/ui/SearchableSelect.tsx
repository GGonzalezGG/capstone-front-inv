...
const SearchableSelect: React.FC<SearchableSelectProps> = ({
  ...
  // 1. Si está buscando, muestra el 'searchTerm'.
  // 2. Si está abierto pero vacío, muestra vacío.
  // 3. Si está cerrado, muestra el 'label' de la opción seleccionada (si hay una).
  ...
  return (
    <div className="relative w-full" ref={wrapperRef}>
      <Input
        ...
        disabled={disabled}
        autoComplete="off"
        // Oculta el label de tu componente Input si es redundante
        // (o ajusta el Input para que el label sea opcional)
        containerClassName={label ? '' : 'mt-5'} // Ajuste si no hay label
      />

      {isOpen && (
        <div className="absolute z-10 w-full mt-1">
          {/* Usamos tu Card para un estilo consistente */}
